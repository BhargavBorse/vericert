...
firebase.auth().onAuthStateChanged(function(user) {
    if (user) {
        ...
        firebase.database().ref().child('users').child(id).child('certificates').on('child_added',function(feed_deep_snapshot){
            var feed_deep_key = feed_deep_snapshot.key;
            firebase.database().ref().child('users').child(id).child('certificates').child(feed_deep_key).on('value',function(feed_snapshot){
