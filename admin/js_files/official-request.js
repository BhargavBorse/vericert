...
firebase.database().ref().child('officials').on('child_added',function(feed_snapshot){
    ...
    if(login_status === 'inactive')
    {
        ...
        alink_more_details.href = "official-request.html?id="+id;
        ...
        // alink_more_details.setAttribute('class',"fa fa-info")
        blink_more_details.href = "request-official-detail.html?id="+id; 
